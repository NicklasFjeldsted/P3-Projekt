...
EXEC sp_create_customer @Email = 'matthiasskovbryde@gmail.com', @Password = 'Passw0rd', @Country = 45, @Phone = 01232567, @CPR = '0123226789', @FirstName = 'Matthias', @LastName = 'Skov Bryde', @Address = 'Ole Suhrs Gade 23', @ZipCode = 1354, @Gender = 1, @returnValue = "error"
GO