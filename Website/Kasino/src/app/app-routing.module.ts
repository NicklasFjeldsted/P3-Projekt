...
import { IndbetalingsgraenseComponent } from './components/indbetalingsgraense/indbetalingsgraense.component';
...
const routes: Routes = [
  ...
  { path: 'indbetalingsgrænse', component: IndbetalingsgraenseComponent, canActivate: [ AuthenticationGuard]},
